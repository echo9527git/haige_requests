...
class WWCompanyLabel:
    ...
    # 获取企业标签库
    def get_corp_tag_list(self,request):
        r = request.post(self._baseurl+'/externalcontact/get_corp_tag_list', params={
            'access_token_3': self.access_token
        })
        return r

    # 添加企业客户标签---两个都是必填参数
    def add_corp_tag(self,request,group_name,tag_name):
        r = request.post(self._baseurl+'/externalcontact/add_corp_tag',
    ...
    # 删除企业客户标签
    def del_corp_tag(self,request,group_id=None,tag_id=None):
        ...
        r = request.post(self._baseurl+'/externalcontact/del_corp_tag',
                      params={'access_token_3': self.access_token},
                      json=json
        )
        return r
    ...
    # 获取tag_id或者是group_id
    def get_group_tag_id_by_name(self,request=None,group_name=None,tag_name=None):
        group_id = None
        tag_id = None

        r = self.get_corp_tag_list(request)
